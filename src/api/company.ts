...
export const deleteCompanyMembers = async (companyId: number, emailObject: object) => {
  const {data} = await authorizationClient.delete(`${API.COMPANIES}/${companyId}/members`, emailObject);
  return data;
};